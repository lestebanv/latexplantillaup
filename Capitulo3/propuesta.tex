...
\chapter{Modelo de despliegue de procesos}
...
\begin{figure}
  \centering
    \includegraphics[scale=0.1]{Capitulo2/imagenes/escudogriseslineas}      %Ruta completa de la imagen, porque se compila desde el archivo tesis.tex
